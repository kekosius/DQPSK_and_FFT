...
//#define DEBUG							//Разкомментить для отправки по USART информации о принятом сигнале в виде значений напряжения

//#define FILTER_TEST					//Разкомментить для отправки по USART информации о работе частотного фильтра
