\doxysection{Documents/\+Keil/\+DQPSK\+\_\+plus\+\_\+\+Freq/\+Source/\+ADC\+\_\+lib.c File Reference}
\hypertarget{_a_d_c__lib_8c}{}\label{_a_d_c__lib_8c}\index{Documents/Keil/DQPSK\_plus\_Freq/Source/ADC\_lib.c@{Documents/Keil/DQPSK\_plus\_Freq/Source/ADC\_lib.c}}
...
{\em Real\+Voltage} & напряжение в милливольтах\\
\hline
\end{DoxyRetVals}
Подсчёт напряжения происходит в рассчете на то, что на вход приходит напряжение с добавленной константой \mbox{[}INPUT\+\_\+\+AMPLITUDE/2\mbox{]}, которую нужно игнорировать. Такая константа добавляется внешней платой МСД-\/ТМ (подключение и принцип работы описан в README.\+md) и необходима в силу того, что АЦП контроллера Geehy отсутсвует возможность приёма сигнала с отрицательным напряжением. Другими словами, МСД-\/ТМ \"{}поднимает\"{} входной сигнал таким образом, чтобы он был всегда \texorpdfstring{$>$}{>}= 0, далее ту константу, которую прибавили к сигналу, вычитаем программно 
